...
public class LambdaTestUtility {
    ...
    public static WebDriver initializeLambdaTest(String browserName, String testName) {
        ...
        ltOptions.put("user", "sravanthiveshala92");
        ltOptions.put("accessKey", "LT_DcsKeIndKaeENEqvEBvsXiPEP4jK1gPb25FMawTfDWFLm67");
		...
		try {
			driver = new RemoteWebDriver(new URL(HUB_URL), desiredCapabilitiesLocal.get());
